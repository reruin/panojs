...
:cropPreprocess
	...
	md "%id%/tiles/cube/mid"
	for /l %%x in (0,1,5) do (
		setlocal enabledelayedexpansion
		set /a ix = 2048 * %%x
		"C:\Program Files\GraphicsMagick-1.3.20-Q8\gm.exe"  convert -crop 2048x2048+!ix!+0 -resize 1024x1024 +profile "*"  %id%/raw/cube.%sImgTypeRaw% %id%/tiles/cube/mid/%%x.jpg
	)
