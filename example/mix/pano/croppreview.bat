...
set _size=256
set /p _size="Tile Size(default is 256) : "
set /a size=_size
...
:cropPreview
	echo ===== Crop Preview =====
	"C:\Program Files\GraphicsMagick-1.3.20-Q8\gm.exe"  convert -resize 1536x256 -quality 50 +profile "*"  %id%/raw/cube.%sImgTypeRaw% %id%/tiles/cube/preview.jpg
goto :eof
